...
/***/ "./resources/js/my_custom_bulma.js":
/*!*****************************************!*\
  !*** ./resources/js/my_custom_bulma.js ***!
  \*****************************************/
/***/ (() => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function menuItem(item) {
    ...
    var nextSibling = item.target.nextSibling.nextSibling.classList;
    item.target.classList.toggle("has-background-grey");
    nextSibling.toggle("is-hidden");
  }

  var menuDropdown = document.querySelectorAll("#header-toggle");
  menuDropdown.forEach(function (menu) {
    menu.addEventListener("click", menuItem);
  }); // ========= Notification close ===========

  var deleteNotification = document.querySelectorAll(".delete-notification");
  deleteNotification.forEach(function (singleNotification) {
    var notification = singleNotification.parentNode;
    singleNotification.addEventListener("click", function () {
